...
//   // State for the selected logo file (for new or updated logo)
//   const [logoFile, setLogoFile] = useState(null);
//   // State for the image preview URL (either selected file's object URL or existing company's logo URL)
//   const [logoPreviewUrl, setLogoPreviewUrl] = useState('');

//   // Helper to get the current company object being viewed/edited
//   const currentCompany = editingCompany || newCompany;
...
//   // Handler to update the current company object state for text inputs
//   const handleInputChange = (e) => {
//     const { name, value } = e.target;
//     if (newCompany) {
//       setNewCompany({ ...newCompany, [name]: value });
